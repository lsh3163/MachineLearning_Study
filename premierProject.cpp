...
int main(){
	...
	while (cnt--){
		...
		my_neuron.propBackward(81.0);
		printf("w = %lf b = %lf\n", my_neuron.w_, my_neuron.b_);
		printf("Training\n");
		my_neuron.feedForwardAndPrint(2.0);
		my_neuron.propBackward(71.0);
		printf("w = %lf b = %lf\n", my_neuron.w_, my_neuron.b_);
		printf("Training\n");
		my_neuron.feedForwardAndPrint(3.0);
		my_neuron.propBackward(70.0);
		printf("w = %lf b = %lf\n", my_neuron.w_, my_neuron.b_);
		printf("Training\n");
		my_neuron.feedForwardAndPrint(4.0);
		my_neuron.propBackward(66.0);
		printf("w = %lf b = %lf\n", my_neuron.w_, my_neuron.b_);
		printf("Training\n");
		my_neuron.feedForwardAndPrint(5.0);
		my_neuron.propBackward(66.0);
		printf("w = %lf b = %lf\n", my_neuron.w_, my_neuron.b_);
	}
	my_neuron.print(1.0);
